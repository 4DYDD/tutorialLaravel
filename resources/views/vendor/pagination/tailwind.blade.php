        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm leading-5 text-gray-700 dark:text-gray-400">
                    ...
                    Artikel {{ request('name') && !request('category') ? ' - ' . request('name') : '' }}
                </p>
            </div>
                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span
                                            class="relative flex items-center justify-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-400 bg-white border border-gray-300 cursor-default dark:bg-gray-800 dark:border-gray-600">
                                            {{-- LOGO PANAH --}}
                                            <svg class="absolute w-full h-4 animate-bounce -top-4" aria-hidden="true"
